...
import './layout.css';
export default function Layout({ children, id, reportProblemUrl, reportProblemTitle, reportProblemRelativeSourcePath}) {
  return (
    <div id={id}>
      <Helmet>
        <title >
...
Spinnaker
          ...
          <ul className="nav navbar-nav ml-auto">
            <li className="nav-item">
              <a className="nav-link" href="https://www.jenkins.io/node/">
...
Documentation
              ...
              <div className="dropdown-menu">
                <a className="dropdown-item feature" href="https://www.jenkins.io/doc/book/">
                  <strong >
                    
User Guide
                  </strong>
                </a>
                <a className="dropdown-item" href="https://www.jenkins.io/doc/book/installing/">
...
Events
                ...
                <a className="dropdown-item feature" href="https://community.jenkins.io/">
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-4">
              <ReportAProblem reportProblemUrl={reportProblemUrl} reportProblemTitle={reportProblemTitle} reportProblemRelativeSourcePath={reportProblemRelativeSourcePath} />
